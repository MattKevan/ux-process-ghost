...
export const ghostAPIUrl = process.env.CMS_GHOST_API_URL || 'https://ao-ux-process.herokuapp.com'
export const ghostAPIKey = process.env.CMS_GHOST_API_KEY || '1e5d520841c525f6b88cfccb62'
